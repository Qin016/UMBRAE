...
# -*- coding: utf-8 -*-
'''
@File    :   train_brainx.py
@Time    :   2024/02/14 13:17:16
@Author  :   Weihao Xia 
@Version :   1.0
@Desc    :   cross-subject training
@usage   :   accelerate launch --num_processes=1 --num_machines=1 --gpu_ids='0' train_brainx.py \
                --data_path '/home/wx258/project/nsd_data' --fmri_encoder 'brainx' --batch_size 128 --num_epochs 300 \
